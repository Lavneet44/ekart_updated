...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2023 at 07:48 AM
...
CREATE TABLE `attributes` (
  ...
  `selected_seller` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `carts` (`id`, `customer_id`, `cart_group_id`, `product_id`, `color`, `choices`, `variations`, `variant`, `quantity`, `price`, `tax`, `discount`, `slug`, `name`, `thumbnail`, `seller_id`, `seller_is`, `created_at`, `updated_at`, `shop_info`) VALUES
(64, 7, '1672323779', 12, '#F0F8FF', NULL, '{\"color\":\"#F0F8FF\"}', '3', 8, 9999, 1799.82, 0, 'dell-xmJywY', 'Dell', '2022-12-28-63ac16e11c637.png', 5, 'seller', '2022-12-29 14:22:59', '2022-12-29 14:22:59', 'Chetan Garments');
...
CREATE TABLE `categories` (
  ...
  `id_of_creater` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `selected_cat` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `category_blocks` (
  ...
  `level1_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level2_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(20, 'Checking Update Discount', '46', 1, 12, '1,2,3', 5, 1, 1, 0, 0, '2022-12-28 15:47:29', '2022-12-28 15:47:29');
...
CREATE TABLE `plan_offers` (
  `id` int(11) NOT NULL,
  `offer_title` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `possible_combination_elements` (
  `id` int(11) NOT NULL,
  `combination_string` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `seller_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(460, '[[\"color\",\"#9966CC\"]]', 5, '2022-12-29 15:43:44', '2022-12-29 15:43:44');
...
(4278, 5, '#9966CC', NULL, 1, '2022-12-29 15:43:44', '2022-12-29 15:43:44');
...
CREATE TABLE `products` (
  ...
  `images` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `discount` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'not in use',
...
(12, 'seller', 5, 'Dell', '0005-00001', 'Dell-45613215', '121651s', NULL, 'dell-xmJywY', '[\"46\"]', 1, '1', 1, 1, '[\"2022-12-28-63ac16e0828e7.png\"]', '2022-12-28-63ac16e11c637.png', NULL, NULL, 'youtube', NULL, '[\"#F0F8FF\",\"#9966CC\"]', 1, 0, '[\"2\",\"3\"]', '[{\"name\":\"choice_2\",\"title\":\"RAM\",\"options\":[\"16GB\"]},{\"name\":\"choice_3\",\"title\":\"SSD\",\"options\":[\"512GB\",\"              1TB\",\"          2TB\"]}]', '[]', 0, 9999.000, 0.000, '18', 'percent', NULL, NULL, 290, '<p>Lorem Ipsum</p>', 0, NULL, '2022-12-28 10:13:53', '2022-12-29 10:07:48', 1, 1, NULL, NULL, 'def.png', 1, NULL);
...
CREATE TABLE `product_discounts` (
  ...
  `free_qty` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(19, 20, '46', '1', 12, 1, 1, 10, 999, 9999, 70, 'Each', '2022-12-23 15:47:00', '2023-01-08 16:46:00', '2022-12-23', '15:47:00', '2023-01-08', '16:46:00', 70, 10, '1,4', '12,12', 1, 0, 5, 0, '2022-12-29', '2022-12-29'),
(20, 20, '46', '1', 12, 2, 1, 10, 999, 9999, 50, 'Each', '2022-12-23 15:47:00', '2023-01-08 16:46:00', '2022-12-23', '15:47:00', '2023-01-08', '16:46:00', 50, 4, '1,4', '12,12', 1, 0, 5, 0, '2022-12-29', '2022-12-29'),
(21, 20, '46', '1', 12, 3, 0, 10, 999.9, 9999, 70, 'Each', '2022-12-23 15:47:00', '2023-01-08 16:46:00', '2022-12-23', '15:47:00', '2023-01-08', '16:46:00', 50, 10, '1,4', '12,12', 1, 0, 5, 0, '2022-12-29', '2022-12-29');
...
CREATE TABLE `product_variant` (
  ...
  `orignalstr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `product_variant` (`id`, `product_id`, `type`, `orignalstr`, `price`, `variant_image`, `sku`, `qty`, `discount`, `discount_percent`, `startDuration`, `endDuration`, `buyquantity`, `freequantity`, `item`, `verify_status`, `isEnable`, `created_at`, `updated_at`) VALUES
(1, 12, '#F0F8FF-16GB-512GB', '#F0F8FF-16GB-512GB', 9999, '2022-12-29-63ad67ad13025.png', 'Dell-AliceBlue-16GB-512GB', 70, 0, 0.00, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, 1, '2022-12-28 15:43:53', '2022-12-29 15:40:53'),
(2, 12, '#F0F8FF-16GB-1TB', '#F0F8FF-16GB-1TB', 9999, NULL, 'Dell-AliceBlue-16GB-1TB', 50, 0, 0.00, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, 1, '2022-12-28 15:43:53', '2022-12-29 15:40:53'),
(3, 12, '#9966CC-16GB-512GB', '#9966CC-16GB-512GB', 9999, NULL, 'Dell-Amethyst-16GB-512GB', 50, 0, 0.00, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, 1, '2022-12-28 15:43:53', '2022-12-29 15:40:53'),
(4, 12, '#9966CC-16GB-1TB', '#9966CC-16GB-1TB', 9998, NULL, 'Dell-Amethyst-16GB-1TB', 50, 0, 0.00, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, 1, '2022-12-28 15:43:53', '2022-12-29 15:40:53'),
(5, 12, '#F0F8FF-16GB-2TB', '#F0F8FF-16GB-2TB', 8999, '2022-12-29-63ad67ad2864f.png', 'AliceBlue-16GB-2TB', 20, NULL, 0.00, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, 1, '2022-12-28 15:45:28', '2022-12-29 15:40:53'),
(6, 12, '#9966CC-16GB-2TB', '#9966CC-16GB-2TB', 8999, NULL, 'Amethyst-16GB-2TB', 50, NULL, 0.00, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, 1, '2022-12-28 15:45:28', '2022-12-29 15:40:53');
...
CREATE TABLE `sellers` (
  ...
  `new_seller_status` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `shops` (
  ...
  `address4` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address5` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country` int(11) DEFAULT NULL,
  `vat_no` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_name` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ac_holder_name` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ac_number` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `swift_number` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `iban_number` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `reg_or_cr_number` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `group_vat` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `division_vat` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telephone_number` bigint(20) DEFAULT NULL,
  `whatapp_number` bigint(20) DEFAULT NULL,
  `shop_email` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_plans` (
  ...
  `duration_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(7, NULL, 'abc', 'abc', '1111111111', NULL, 'def.png', 'abc@gmail.com', NULL, '$2y$10$TXcMlQ4wWIjli6fO1F9KM.Hk/zaJo9AITFEcLlyL4utGqYCYCf8YW', 'Cm90kbxNdUm7LlWqC9rFZLDa181MYoeikvKWsZ8m67zrB1wpYjllyxOgZ0qj', '2022-07-20 12:29:54', '2022-07-20 12:29:54', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0),
...
--
ALTER TABLE `possible_variant`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4279;
